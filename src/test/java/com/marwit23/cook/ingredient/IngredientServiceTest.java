...
public class IngredientServiceTest {
    ...
    // * item name does not exits
    @Test
    public void testFindByName_DoesNotExist(){
        when(ingredientRepository.findByIngredientName(anyString())).thenReturn(Optional.empty());
        Assertions.assertThrows(EntityNotFoundException.class, ()-> ingredientService.findByName("testFindByName_DoesNotExist"));
    }
}
